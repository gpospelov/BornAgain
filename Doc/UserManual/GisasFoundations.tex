...
whenever $n(z)$ varies within the sample.
As a result, at any $z$ within the zone where $n(z)$ varies,
...
If otherwise $n(z)$ is discontinuous at some interface $z=z_j$,
...
discussed in \cref{sec:Multilayers}.
...
that is governed by the complex wave equation \cref{Ewavez}.
