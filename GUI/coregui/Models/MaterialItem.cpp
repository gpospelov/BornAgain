...
//{
//    m_sub_items[P_REFRACTIVE_INDEX]->setRegisteredProperty(Refracti, QString::number(delta));
//    m_sub_items[P_REFRACTIVE_INDEX]->setMaterialProperty("beta", QString::number(beta));
//}
