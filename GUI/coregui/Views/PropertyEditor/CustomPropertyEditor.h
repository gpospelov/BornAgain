...
//
//! @file      coregui/Views/PropertyEditor/CustomPropertyEditor.h
//! @brief     Defines class CustomPropertyEditor
//!
...
class BA_CORE_API_ CustomPropertyEditor : public QWidget
{
    Q_OBJECT
...
public:
    ...
    CustomPropertyEditor(QItemSelectionModel *selection_model,
