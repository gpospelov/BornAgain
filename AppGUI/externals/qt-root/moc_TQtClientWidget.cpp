...
struct qt_meta_stringdata_TQtClientWidget_t {
    QByteArrayData data[4];
    char stringdata[40];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_TQtClientWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_TQtClientWidget_t qt_meta_stringdata_TQtClientWidget = {
    {
...
QT_MOC_LITERAL(3, 28, 10)
    ...
    "TQtClientWidget\0Disconnect\0\0Accelerate\0"
};
...
const QMetaObject TQtClientWidget::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_TQtClientWidget.data,
      qt_meta_data_TQtClientWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TQtClientWidget.stringdata))
