...
struct IMaterial_wrapper : IMaterial, bp::wrapper< IMaterial > {
    ...
    virtual ::IMaterial const * createTransformedMaterial( ::Geometry::PTransform3D const & transform ) const  {
        if( bp::override func_createTransformedMaterial = this->get_override( "createTransformedMaterial" ) )
            ...
            return this->IMaterial::createTransformedMaterial( transform );
        }
    }
    
    ::IMaterial const * default_createTransformedMaterial( ::Geometry::PTransform3D const & transform ) const  {
        return IMaterial::createTransformedMaterial( transform );
    }
...
void register_IMaterial_class(){
    ...
    { //::IMaterial
        ...
        { //::IMaterial::createTransformedMaterial
            ...
            typedef ::IMaterial const * ( ::IMaterial::*createTransformedMaterial_function_type )( ::Geometry::PTransform3D const & ) const;
            typedef ::IMaterial const * ( IMaterial_wrapper::*default_createTransformedMaterial_function_type )( ::Geometry::PTransform3D const & ) const;
