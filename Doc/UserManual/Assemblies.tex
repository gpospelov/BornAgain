...
\end{equation}
Implemented form factors will be presented in Chapter~\ref{SFF}.
In the following,
we will discuss interferences due the exponential term in (\ref{Eass4})
that carry information about the two-dimensional arrangement of
