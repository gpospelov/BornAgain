...
def get_sample():
    ...
    #interference = ba.InterferenceFunction2DParaCrystal.createHexagonal(20.0*nanometer,
    interference = ba.InterferenceFunction2DParaCrystal.createSquare(20.0*nanometer,
