...
\def\defineBox#1#2#3#4#5{
  ...
  \newenvironment{#1}
    {\begin{#2*}#5\ignorespaces}
    {\end{#2*}}
}

\def\defineBoxWithMarginsym#1#2#3#4#5#6#7{
\defineBox{#1}{#2}{#3}{#4}{\makebox[0pt][r]{\smash{\raisebox{-#7}%
{\includegraphics[width=#6]{#5}\hspace{10pt}}}}}
}


\defineBoxWithMarginsym{boxWork}{boxxWork}{magenta!40}{magenta}{fig/fancymanual/Arbeiten.png}{3em}{3ex}
\defineBoxWithMarginsym{boxWarn}{boxxWarn}{magenta!40}{magenta}{fig/fancymanual/Achtung.png}{3em}{3ex}
...
\def\coloredBox#1#2%
{\noindent\colorbox{#1}{\begin{minipage}
{1\textwidth}\strut\hspace{\myparindent}#2\end{minipage}}}

\def\ddanger{%
\raisebox{-.5ex}{\makebox[2.8em][c]{%
\makebox[0pt][c]{\raisebox{.3em}{\large!}}%
\makebox[0pt][c]{\color{red}\Huge$\bigtriangleup$}}}}%

\def\colorWarn{red!30}
\def\colorNote{yellow!30}
\def\colorEmph{blue!10}
...
%\Warn{\ldots\ to be written \ldots}}

\def\cbNote{\noindent\colorbox{\colorNote}}
\def\cbEmph{\noindent\colorbox{\colorEmph}}
