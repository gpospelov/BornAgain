...
void register_IInterferenceFunction_class(){
    ...
    { //::IInterferenceFunction
        ...
        { //::ISample::preprocess
            ...
            typedef bool ( IInterferenceFunction_wrapper::*default_preprocess_function_type)(  ) ;
            
            IInterferenceFunction_exposer.def( 
                "preprocess"
                , preprocess_function_type(&::ISample::preprocess)
                , default_preprocess_function_type(&IInterferenceFunction_wrapper::default_preprocess) );
