...
\end{equation}
In Sect.~\ref{Smulayabs} we will discuss how to interpret this expression
...
Often, the transmitted and reflected amplitudes~$A^-$ and $A^+$ are
designated by distinct letters $t$ and $r$,
a usage which we will \E{not} follow in this manual.
\nomenclature[2t026 2w020 2l020 0]{$t_{w\il}$}{Partial amplitude of $\psi_w(\r)$
  in layer $\il$ in downward (transmission) direction, in this work denoted $A^-_{w\il}$}%
\nomenclature[2r026 2w020 2l020 0]{$t_{w\il}$}{Partial amplitude of $\psi_w(\r)$
  in layer $\il$ in upward (reflection) direction, in this work denoted $A^+_{w\il}$}%
for the transmitted and reflected amplitude.
\index{Transmitted amplitude}%
\index{Reflected amplitude}%
...
Yet the algebraic formalism developed in Sect.~\ref{Slayerprop}
remains applicable.
...
\begin{equation}
  \k^\pm \eqqcolon {\k^\pm}' + i{\k^\pm}'' = \k_\plll \pm (k_\perp' + i k_\perp'')\v{\hat z}.
\end{equation}
...
following (\ref{EMil}) holds with exchanged order of layers:
