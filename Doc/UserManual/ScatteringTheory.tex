...
Obviously, the horizontal integration domain is limited to
the \textit{illuminated sample area}.\footnote
...
lest unused rays cause avoidable noise).
Anyhow, the $xy$ integral is limited to the illuminated sample area
...
{These two references also make clear that
  ...
  coherence lengths are difficult tasks and subject of ongoing research.}
The contrary is true for the scattering of synchrotron radiation,
where the coherence length typically exceeds the size
of the illuminated sample spot.
