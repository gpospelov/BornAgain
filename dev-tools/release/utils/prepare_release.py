...
def cmake_release():
    ...
    cmd = "cd %s; cmake -DBORNAGAIN_APP=ON -DBORNAGAIN_GUI=ON -BORNAGAIN_USERMANUAL=ON -DBORNAGAIN_RELEASE=ON -DCMAKE_INSTALL_PREFIX=%s %s" % (get_build_dir(), get_install_dir(), get_source_dir() )
    run_command(cmd)
