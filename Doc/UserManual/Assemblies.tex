...
\end{equation}
\nomenclature[2n033 0]{$\tilde{n}_0(z)$}{Renormalized refractive index
  of an embedding material (``matrix'')}
and    
\begin{equation}
    \tilde{n}_p^2(\r) := n_p^2(\r) - n_0^2(z).
\end{equation}
\nomenclature[2n033 2]{$\tilde{n}_p(\r)$}{Renormalized refractive index
  of embedded particle material}
