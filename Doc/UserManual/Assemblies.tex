...
\index{Nanoparticle|see {Particle}}%
\index{Mesoparticle|see {Particle}}%
...
\begin{equation}\label{EPDdeltas}
  \PD(\r,\v\tau,\v\tau')
  \coloneqq \sum_{jk} \delta^{2}(\r-(\R_{j\plll}-\R_{k\plll}))
  \delta^{n}(\v\tau-\v{T}_j)\delta^{n}(\v\tau'-\v{T}_k).
\end{equation}
The exponents denote the dimensionalities of the delta-functions;
$n$~is the dimensionality of~$\v\tau$.
...
it describes the incoherent sum
\index{Incoherent sum}%
of scattering from different coherence domains.
In \BornAgain,
...
it is only available for paracrystals (\cref{SPara}).}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Paracrystals}\label{SPara}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%===============================================================================
\subsection{The one-dimensional paracrystal} \label{SPara1}
%===============================================================================
...
%===============================================================================
\subsection{The radial paracrystal} \label{SParaR}
%===============================================================================
...
%===============================================================================
\subsection{The two-dimensional paracrystal} \label{SPara2}
%===============================================================================
...
\paragraph{Syntax:}
 \Code{particle\_layout.setInterferenceFunction(interference\_function)},\\ where \Code{particle\_layout} holds the information about the different shapes and their proportions for a given layer of particles, and \Code{interference\_function}  is one of the following expressions:
\begin{itemize}
