...
void register_FormFactorTruncatedSpheroid_class(){
    ...
    { //::FormFactorTruncatedSpheroid
        ...
        { //::IFormFactorBorn::evaluate
            ...
            typedef ::complex_t ( FormFactorTruncatedSpheroid_wrapper::*default_evaluate_function_type)( ::WavevectorInfo const & ) const;
        ...
        { //::ISample::getChildren
            ...
            typedef ::std::vector< const ISample* > ( FormFactorTruncatedSpheroid_wrapper::*default_getChildren_function_type)(  ) const;
            
            FormFactorTruncatedSpheroid_exposer.def( 
                "getChildren"
                , getChildren_function_type(&::ISample::getChildren)
                , default_getChildren_function_type(&FormFactorTruncatedSpheroid_wrapper::default_getChildren) );
        ...
        { //::ISample::size
            ...
            typedef ::std::size_t ( FormFactorTruncatedSpheroid_wrapper::*default_size_function_type)(  ) const;
            
            FormFactorTruncatedSpheroid_exposer.def( 
                "size"
                , size_function_type(&::ISample::size)
                , default_size_function_type(&FormFactorTruncatedSpheroid_wrapper::default_size) );
