...
\chapter{Scattering by embedded particles}  \label{SFF}
...
The number of input parameters for the form factor depends
on the particle symmetry;
it ranges from one parameter for a sphere (its radius)
to three for an ellipsoid (its three main axis lengths).
...
\def\xx{\hspace{2em}}
\begin{table}[H] \small
  \begin{tabulary} {\textwidth}{L@{\xx}L@{\xx}L@{\xx}L} 
\hline 
...
\item height $H$,
\item $\alpha$ is the angle between the base and a side face.
\end{itemize}
They must fulfill
\begin{displaymath}
...
\item height $H$,
\item angle $\alpha$ between the base and a side face.
\end{itemize}
They must fulfill
\begin{displaymath}
...
\item height $H$ of the bottom pyramid,
\item height ratio $r_H$ bewteen the top and the bottom pyramid,
\item angle $\alpha$ between the base and a side face.
\end{itemize}
They must fulfill
\begin{displaymath}
...
\item height $H$,
\item angle $\alpha$ the base and a side face.
\end{itemize}
They must fulfill
\begin{displaymath}
