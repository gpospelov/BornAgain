...
This \textit{quantum-mechanical sign convention}
is used throughout this manual, and implemented in BornAgain,
including for X-ray scattering.
This is in conflict with parts of the X-ray literature
(e.~g.\ \cite{ReLL09})
where the opposite \textit{crystallographic sign convention}
with a phase factor ${\rm e}^{+i\omega t}$ is used.
...
\end{equation}
Since we only consider stationary situations,
