...
void register_FormFactorTetrahedron_class(){
    ...
    { //::FormFactorTetrahedron
        ...
        { //::ISample::getChildren
            ...
            typedef ::std::vector< const ISample* > ( FormFactorTetrahedron_wrapper::*default_getChildren_function_type)(  ) const;
        ...
        { //::ISample::size
            ...
            typedef ::std::size_t ( FormFactorTetrahedron_wrapper::*default_size_function_type)(  ) const;
            
            FormFactorTetrahedron_exposer.def( 
                "size"
                , size_function_type(&::ISample::size)
                , default_size_function_type(&FormFactorTetrahedron_wrapper::default_size) );
