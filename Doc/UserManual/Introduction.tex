...
Therefore, \Cref{sec:online} just contains a few pointers to the web site.
...
\medskip
\demobox{\Tuto{\indent Such a box provides one or several links
  to a usages examples in the online tutorial,
  like the basic script \tuto{52}{cylinders in distorted wave Born approximation}
  or the long list of \tuto{72}{all available form factors}.}}
