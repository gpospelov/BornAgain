...
//
//! @file      Tools/inc/MemberFunctionMCVegasIntegrator.h
//! @brief     Defines and implements template class MemberFunctionMCVegasIntegrator.
//!
...
#ifndef MEMBERFUNCTIONMCVEGASINTEGRATOR_H
#define MEMBERFUNCTIONMCVEGASINTEGRATOR_H

#include "gsl/gsl_monte_vegas.h"

//! @class MemberFunctionMCVegasIntegrator
//! @ingroup tools_internal
//! @brief Template class to use Monte Carlo VEGAS integration of class member functions
//!
//! Wrap integrator from GNU Scientific Library.

template <class C> class MemberFunctionMCVegasIntegrator
{
public:
    ...
    MemberFunctionMCVegasIntegrator(
...
template<class C> MemberFunctionMCVegasIntegrator<C>::MemberFunctionMCVegasIntegrator(
        mem_function p_member_function, const C *const p_object, size_t dim)
...
template<class C> double MemberFunctionMCVegasIntegrator<C>::integrate(
...
#endif // MEMBERFUNCTIONMCVEGASINTEGRATOR_H
