...
This section shortly describes how to build \BornAgain\ from source and run the first
simulation. More details about software architecture and installation
procedure are given in \SecRef{SoftwareArchitecture} and \SecRef{Installation}. \\
