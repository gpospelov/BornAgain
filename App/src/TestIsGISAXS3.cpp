...
void TestIsGISAXS3::execute()
{
    ...
    test.runDWBA();
     OutputDataIOFactory::writeOutputData(*test.getOutputData(), getOutputPath()+"this_cylinder_DWBA.ima");
    test.runBA();
     OutputDataIOFactory::writeOutputData(*test.getOutputData(), getOutputPath()+"this_cylinder_BA.ima");
    test.runBA_Size();
     OutputDataIOFactory::writeOutputData(*test.getOutputData(), getOutputPath()+"this_cylinder_BA_size.ima");
}
