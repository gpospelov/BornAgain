...
void PyExportTest::runTest()
{
    ...
    std::string pyscript_filename = BUILD_TMP_DIR + "/pyexport_" + getName() + ".py";
    ...
    // Run Python script
    std::string output_name = BUILD_TMP_DIR + "/pyexport_" + getName();
    std::string output_path = output_name + ".int";
    std::remove( output_path.c_str() );
    std::cout << "Removed old data set " << output_path << "." << std::endl/*sic*/;
    std::string command = std::string(BORNAGAIN_PYTHON_EXE) + " " + pyscript_filename +
        " " + output_name;
