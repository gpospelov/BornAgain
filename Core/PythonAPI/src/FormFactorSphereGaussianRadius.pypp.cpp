...
struct FormFactorSphereGaussianRadius_wrapper : FormFactorSphereGaussianRadius, bp::wrapper< FormFactorSphereGaussianRadius > {
    ...
    virtual double getRadius(  ) const  {
        if( bp::override func_getRadius = this->get_override( "getRadius" ) )
            ...
            return this->FormFactorSphereGaussianRadius::getRadius(  );
        }
    }
    
    double default_getRadius(  ) const  {
        return FormFactorSphereGaussianRadius::getRadius( );
    }
...
void register_FormFactorSphereGaussianRadius_class(){
    ...
    { //::FormFactorSphereGaussianRadius
        ...
        { //::FormFactorSphereGaussianRadius::getRadius
        
            typedef double ( ::FormFactorSphereGaussianRadius::*getRadius_function_type)(  ) const;
            typedef double ( FormFactorSphereGaussianRadius_wrapper::*default_getRadius_function_type)(  ) const;
            
            FormFactorSphereGaussianRadius_exposer.def( 
                "getRadius"
                , getRadius_function_type(&::FormFactorSphereGaussianRadius::getRadius)
        ...
        { //::IFormFactorBorn::evaluate
            ...
            typedef ::complex_t ( FormFactorSphereGaussianRadius_wrapper::*default_evaluate_function_type)( ::WavevectorInfo const & ) const;
        ...
        { //::ISample::getChildren
            ...
            typedef ::std::vector< const ISample* > ( FormFactorSphereGaussianRadius_wrapper::*default_getChildren_function_type)(  ) const;
            
            FormFactorSphereGaussianRadius_exposer.def( 
                "getChildren"
                , getChildren_function_type(&::ISample::getChildren)
                , default_getChildren_function_type(&FormFactorSphereGaussianRadius_wrapper::default_getChildren) );
        ...
        { //::ISample::size
            ...
            typedef ::std::size_t ( FormFactorSphereGaussianRadius_wrapper::*default_size_function_type)(  ) const;
            
            FormFactorSphereGaussianRadius_exposer.def( 
                "size"
                , size_function_type(&::ISample::size)
                , default_size_function_type(&FormFactorSphereGaussianRadius_wrapper::default_size) );
