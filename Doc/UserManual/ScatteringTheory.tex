...
\nomenclature[2t0]{$t$}{Time}%
\nomenclature[2r1]{$\r$}{Position}%
\nomenclature[1$\psi$rt]{$\psi(\r,t)$}{Microscopic neutron wave function}%
...
\end{equation}
\nomenclature[2m]{$m$}{Neutron mass}%
\nomenclature[2v5r]{$V(\r)$}{Microscopic optical potential}%
...
\begin{equation}\label{EmacrSchrodi}
  \left\{-\frac{\hbar^2}{2m}\Nabla^2+v(\r)-\hbar\omega\right\} \Psi(\r) = 0,
\end{equation}
\nomenclature[1$\Psi$rt]{$\Psi(\r,t)$}{Coherent wave function}%
\nomenclature[2v0r]{$v(\r)$}{Macrosopic optical potential}%
...
\nomenclature[1$\rho$sr]{$\rho_s(\r)$}{Scattering length density}%
\begin{equation}
  v(\r)=\frac{2\pi \hbar^2}{m}\rho_s(\r),  
\end{equation}
or of a \textit{refractive index}~$n(\r)$
\nomenclature[2n0r]{$n(\r)$}{Refractive index}%
...
\nomenclature[2k5]{$K$}{Vacuum wavenumber, corresponding to the frequency~$\omega$}%
...
\end{equation}
\nomenclature[1$\chi$r]{$\chi(\r)$}{Perturbative potential}%
...
\end{equation}
\nomenclature[1$\Psi$0r]{$\Psi_0(\r)$}{Solution of the unperturbed stationary Schrödinger equation}
...
\end{equation}
\nomenclature[1$\Psi$sr]{$\Psi_\text{s}(\r)$}{Scattered wave function}%
...
\nomenclature[2m7]{$\Sample$}{Sample volume}%
...
\end{equation}
\nomenclature[2g5far]{$G_\text{far}(\r,\r')$}{Far-field approximation to the Green function $G(\r,\r')$}
where
\begin{equation}
  \Psi_\text{f}(\r) := {\rm e}^{i\k_\text{f} \r}
\end{equation}
\nomenclature[1$\Psi$f]{$\Psi_\text{f}(\r)$}{Plane wave propagating from the sample towards the detector}%
...
\end{equation}
\nomenclature[1$\Psi$s_far]{$\Psi_\text{s,far}(\r)$}{Far-field approximation to the scattered wave function $\Psi_\text{s}(\r)$}%
...
\end{equation}
\nomenclature[0$\langle$]{$\bra\ldots\ket$}{Matrix element, defined as a volume integral}%
...
\begin{equation}
  \q:=\k_\text{i}-\k_\text{f},
\end{equation}
\nomenclature[2q1]{$q$}{Scattering vector}%
...
\begin{equation}\label{EBornQ}
  ...
  =: \chi(\q),
\end{equation}
\nomenclature[1$\chi$q]{$\chi(\v{q})$}{Fourier transform of the perturbation potential $\chi(\r)$}%
...
\end{equation}
\nomenclature[2j6r]{$\v{J}(\r)$}{Probability flux}
...
\end{equation}
\nomenclature[1$\Omega$]{$\Omega$}{Solid angle}%
\nomenclature[1$\sigma$]{$\sigma$}{Scattering or absorption cross section}%
...
\begin{equation}\label{EHelmholtzGraded}
  ...
  = \frac{\chi(\r)}{4\pi}\Psi(\r),
\end{equation}
\nomenclature[2z0]{$z$}{Vertizal component of $\r$ (along the sample normal)}%
...
\end{equation}
\nomenclature[2k0$\parallel$]{$k_\parallel$}{Wave vector, projected onto the sample plane}%
\nomenclature[1$\phi$z]{$\phi(z)$}{$z$-dependent factor of $\Psi(\r)$}%
...
\nomenclature[2k0$\perp$]{$k_\perp$}{Wave vector, projected onto the sample normal}%
...
\end{equation}
\nomenclature[2r7]{$\rS$}{Position of a scattering center}%
...
\nomenclature[2b5rr]{$B(\r,\r')$}{Green function, adjoint of $G$}%
...
\end{equation}
\nomenclature[2w0]{$w$}{An index that can take the values i (incident)
or f (final $=$ outgoing)}%
...
\nomenclature[1$\Psi\pm$]{$\Psi^\pm$}{Upward ($+$) or downward ($-$) propagating component of $\Psi$}
