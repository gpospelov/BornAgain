...
\Warn{\indent We also urge users to subscribe to our newsletter
(see Sect.~\ref{Snews}),
and to contact us for any question not answered in the docs.
\index{Bug reports}%
...
We intend to publish additional material with each new software release.}


\bigskip
\noindent We use the following typesetting conventions:
