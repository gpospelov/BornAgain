...
Detailed description of installation procedure is given in \SecRef{Installation}.
...
General methodology of simulation with \BornAgain\ and detailed simulation usage examples are given in \SecRef{Simulation}.
Fitting toolkit provided by the framework are presented in \SecRef{Fitting}.
\SecRef{SoftwareArchitecture} provides brief overview of software architecture
