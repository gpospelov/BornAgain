...
\Work{Until and including version 1.7,
BornAgain does not compute $\Delta v_\sp$ from $v_\sp-v_\sm$,
but uses the given $v_\sp$ in place of $\Delta v_\sp$.}
...
To proceed,
we need to approximate these correlations by statistical models.
