...
\includegraphics[width=\textwidth]{fig/ff2/ff_pyramid.png}
\end{center}
...
\paragraph{Real-space geometry}\strut\\
A spherical dome, \idest a portion of a sphere cut off by a plane (perpendicular
...
\end{align*}
where $\arccos$ is the  arc cosine (\idest the inverse
operation of cosine).
