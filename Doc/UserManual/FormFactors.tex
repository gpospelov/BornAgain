...
The calculation can be derived from ``Prism6'' (\SecRef{Prism6}) by
...
\paragraph{Form factor}
The form factor of the truncated cube is equal to the form factor of the full cube of side length $L$ (see \SecRef{Box}) minus the form factors of the eight trirectangular tetrahedrons \cite{HeSS74}.
