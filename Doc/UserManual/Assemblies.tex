...
\begin{equation}
  ...
  v_l(\r) - \mv_l&\text{~if $\r$ in Layer~$l$,}\\[.2ex]
  0&\text{~otherwise.} \end{array}\right.
\end{equation}
This leaves the constant term $\mv_l$ still undetermined.
