...
struct qt_meta_stringdata_TQtClientGuard_t {
    QByteArrayData data[3];
    char stringdata[28];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_TQtClientGuard_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_TQtClientGuard_t qt_meta_stringdata_TQtClientGuard = {
    {
QT_MOC_LITERAL(0, 0, 14),
QT_MOC_LITERAL(1, 15, 10),
QT_MOC_LITERAL(2, 26, 0)
    },
    "TQtClientGuard\0Disconnect\0\0"
};
...
const QMetaObject TQtClientGuard::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TQtClientGuard.data,
      qt_meta_data_TQtClientGuard,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TQtClientGuard.stringdata))
...
struct qt_meta_stringdata_TQtPixmapGuard_t {
    QByteArrayData data[3];
    char stringdata[28];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_TQtPixmapGuard_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_TQtPixmapGuard_t qt_meta_stringdata_TQtPixmapGuard = {
    {
QT_MOC_LITERAL(0, 0, 14),
QT_MOC_LITERAL(1, 15, 10),
QT_MOC_LITERAL(2, 26, 0)
    },
    "TQtPixmapGuard\0Disconnect\0\0"
};
#undef QT_MOC_LITERAL
...
const QMetaObject TQtPixmapGuard::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TQtPixmapGuard.data,
      qt_meta_data_TQtPixmapGuard,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TQtPixmapGuard.stringdata))
