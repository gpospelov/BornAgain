...
struct FormFactorTruncatedSphere_wrapper : FormFactorTruncatedSphere, bp::wrapper< FormFactorTruncatedSphere > {

    FormFactorTruncatedSphere_wrapper(double radius, double height )
    ...
    virtual ::FormFactorTruncatedSphere * clone(  ) const  {
        if( bp::override func_clone = this->get_override( "clone" ) )
            ...
            return this->FormFactorTruncatedSphere::clone(  );
        }
    }
    
    ::FormFactorTruncatedSphere * default_clone(  ) const  {
    ...
    static void default_registerParameter( ::IParameterized & inst, ::std::string const & name, long unsigned int parpointer, ::AttLimits const & limits=AttLimits::limitless( ) ){
        if( dynamic_cast< FormFactorTruncatedSphere_wrapper * >( boost::addressof( inst ) ) ){
...
void register_FormFactorTruncatedSphere_class(){
    ...
    { //::FormFactorTruncatedSphere
        ...
        { //::FormFactorTruncatedSphere::clone
            ...
            typedef ::FormFactorTruncatedSphere * ( ::FormFactorTruncatedSphere::*clone_function_type)(  ) const;
            typedef ::FormFactorTruncatedSphere * ( FormFactorTruncatedSphere_wrapper::*default_clone_function_type)(  ) const;
            
            FormFactorTruncatedSphere_exposer.def( 
                "clone"
                , clone_function_type(&::FormFactorTruncatedSphere::clone)
                , default_clone_function_type(&FormFactorTruncatedSphere_wrapper::default_clone)
        ...
        { //::IParameterized::areParametersChanged
            ...
            typedef bool ( FormFactorTruncatedSphere_wrapper::*default_areParametersChanged_function_type)(  ) ;
            
            FormFactorTruncatedSphere_exposer.def( 
                "areParametersChanged"
                , areParametersChanged_function_type(&::IParameterized::areParametersChanged)
                , default_areParametersChanged_function_type(&FormFactorTruncatedSphere_wrapper::default_areParametersChanged) );
        
        }
        { //::IParameterized::clearParameterPool
        
            typedef void ( ::IParameterized::*clearParameterPool_function_type)(  ) ;
            typedef void ( FormFactorTruncatedSphere_wrapper::*default_clearParameterPool_function_type)(  ) ;
            
            FormFactorTruncatedSphere_exposer.def( 
                "clearParameterPool"
                , clearParameterPool_function_type(&::IParameterized::clearParameterPool)
                , default_clearParameterPool_function_type(&FormFactorTruncatedSphere_wrapper::default_clearParameterPool) );
        
        }
        { //::ISample::cloneInvertB
        
            typedef ::ISample * ( ::ISample::*cloneInvertB_function_type)(  ) const;
            typedef ::ISample * ( FormFactorTruncatedSphere_wrapper::*default_cloneInvertB_function_type)(  ) const;
            
            FormFactorTruncatedSphere_exposer.def( 
                "cloneInvertB"
                , cloneInvertB_function_type(&::ISample::cloneInvertB)
                , default_cloneInvertB_function_type(&FormFactorTruncatedSphere_wrapper::default_cloneInvertB)
        ...
        { //::ISample::containsMagneticMaterial
            ...
            typedef bool ( FormFactorTruncatedSphere_wrapper::*default_containsMagneticMaterial_function_type)(  ) const;
            
            FormFactorTruncatedSphere_exposer.def( 
                "containsMagneticMaterial"
                , containsMagneticMaterial_function_type(&::ISample::containsMagneticMaterial)
                , default_containsMagneticMaterial_function_type(&FormFactorTruncatedSphere_wrapper::default_containsMagneticMaterial) );
        
        }
        { //::IParameterized::createParameterTree
        
            typedef ::ParameterPool * ( ::IParameterized::*createParameterTree_function_type)(  ) const;
            typedef ::ParameterPool * ( FormFactorTruncatedSphere_wrapper::*default_createParameterTree_function_type)(  ) const;
            
            FormFactorTruncatedSphere_exposer.def( 
                "createParameterTree"
                , createParameterTree_function_type(&::IParameterized::createParameterTree)
                , default_createParameterTree_function_type(&FormFactorTruncatedSphere_wrapper::default_createParameterTree)
                , bp::return_value_policy< bp::manage_new_object >() );
        ...
        { //::IFormFactorBorn::evaluate
            ...
            typedef ::complex_t ( FormFactorTruncatedSphere_wrapper::*default_evaluate_function_type)( ::cvector_t const &,::Bin1DCVector const &,::Bin1D const & ) const;
            
            FormFactorTruncatedSphere_exposer.def( 
                "evaluate"
                , evaluate_function_type(&::IFormFactorBorn::evaluate)
                , default_evaluate_function_type(&FormFactorTruncatedSphere_wrapper::default_evaluate)
        ...
        { //::ISample::getCompositeSample
            ...
            typedef ::ICompositeSample * ( FormFactorTruncatedSphere_wrapper::*default_getCompositeSample_function_type)(  ) ;
        ...
        { //::ISample::getCompositeSample
            ...
            typedef ::ICompositeSample const * ( FormFactorTruncatedSphere_wrapper::*default_getCompositeSample_function_type)(  ) const;
        ...
        { //::IFormFactorBorn::getVolume
            ...
            typedef double ( FormFactorTruncatedSphere_wrapper::*default_getVolume_function_type)(  ) const;
        ...
        { //::IParameterized::printParameters
            ...
            typedef void ( FormFactorTruncatedSphere_wrapper::*default_printParameters_function_type)(  ) const;
            
            FormFactorTruncatedSphere_exposer.def( 
                "printParameters"
                , printParameters_function_type(&::IParameterized::printParameters)
                , default_printParameters_function_type(&FormFactorTruncatedSphere_wrapper::default_printParameters) );
        
        }
        { //::ISample::printSampleTree
        
            typedef void ( ::ISample::*printSampleTree_function_type)(  ) ;
            typedef void ( FormFactorTruncatedSphere_wrapper::*default_printSampleTree_function_type)(  ) ;
            
            FormFactorTruncatedSphere_exposer.def( 
                "printSampleTree"
                , printSampleTree_function_type(&::ISample::printSampleTree)
                , default_printSampleTree_function_type(&FormFactorTruncatedSphere_wrapper::default_printSampleTree) );
        ...
        { //::IFormFactor::setAmbientMaterial
            ...
            typedef void ( FormFactorTruncatedSphere_wrapper::*default_setAmbientMaterial_function_type)( ::IMaterial const & ) ;
            
            FormFactorTruncatedSphere_exposer.def( 
                "setAmbientMaterial"
                , setAmbientMaterial_function_type(&::IFormFactor::setAmbientMaterial)
                , default_setAmbientMaterial_function_type(&FormFactorTruncatedSphere_wrapper::default_setAmbientMaterial)
                , ( bp::arg("material") ) );
        ...
        { //::IParameterized::setParameterValue
            ...
            typedef bool ( FormFactorTruncatedSphere_wrapper::*default_setParameterValue_function_type)( ::std::string const &,double ) ;
            
            FormFactorTruncatedSphere_exposer.def( 
                "setParameterValue"
                , setParameterValue_function_type(&::IParameterized::setParameterValue)
                , default_setParameterValue_function_type(&FormFactorTruncatedSphere_wrapper::default_setParameterValue)
        ...
        { //::IParameterized::setParametersAreChanged
            ...
            typedef void ( FormFactorTruncatedSphere_wrapper::*default_setParametersAreChanged_function_type)(  ) ;
