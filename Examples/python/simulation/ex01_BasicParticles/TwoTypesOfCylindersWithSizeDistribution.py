...
def get_sample():
    ...
    par_distr1 = ba.ParameterDistribution("/Particle/Cylinder/Radius", gauss_distr1, nparticles, nfwhm)
    ...
    par_distr2 = ba.ParameterDistribution("/Particle/Cylinder/Radius", gauss_distr2, nparticles, nfwhm)
