...
%===============================================================================
\section{Refraction, absorption, flux}
  \label{Smulayabs}
%===============================================================================
...
In general, however, the vertical wavenumber $k_{\perp \il}$,
...
the geometric interpretation of the wavevectors $\k_\pm$
in Eqs.~(\ref{Edef_alpha}--\ref{ESnell}) is untenable,
whereas the formalism developed in Sect.~\ref{Slayerprop}
remains applicable.
