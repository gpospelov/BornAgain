...
void register_FormFactorInfLongRipple2_class(){
    ...
    { //::FormFactorInfLongRipple2
        ...
        { //::ISample::preprocess
            ...
            typedef bool ( FormFactorInfLongRipple2_wrapper::*default_preprocess_function_type)(  ) ;
            
            FormFactorInfLongRipple2_exposer.def( 
                "preprocess"
                , preprocess_function_type(&::ISample::preprocess)
                , default_preprocess_function_type(&FormFactorInfLongRipple2_wrapper::default_preprocess) );
