...
We specialize~\cref{Edecompose_vr} to
...
Continuity at the interfaces above and below the sample implies
...
\Note{\indent By convention, illustrated in \cref{Fdefz},
...
The parameter $z_l$ is the $z$ coordinate of the \E{top} interface
\index{Multilayer!coordinates}%
\index{Layer!coordinate}%
\index{Convention!interface coordinate}%
