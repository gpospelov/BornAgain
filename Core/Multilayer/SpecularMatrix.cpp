...
bool calculateUpFromLayer(std::vector<ScalarRTCoefficients>& coeff,
                          ...
                          size_t layer_index);
size_t bisectRTcomputation(std::vector<ScalarRTCoefficients>& coeff, const MultiLayer& sample,
                           const std::vector<complex_t>& kz, const size_t lgood, const size_t lbad,
                           const size_t l);
