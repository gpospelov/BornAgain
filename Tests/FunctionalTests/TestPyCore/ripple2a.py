...
def RunSimulation():
    ...
    ripple2_ff = FormFactorRipple2(20*nanometer, 4*nanometer, 100*nanometer, 3*nanometer)
...
def GetReferenceData():
    ...
    if path: path +="/"
    f = gzip.open(path+'../../ReferenceData/BornAgain/test_ripple2_asym.ima.gz', 'rb')
...
def runTest():
    ...
    return "Ripple2a", "Triangular asymetric ripple within the 1D-paracrystal model", status
