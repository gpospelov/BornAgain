...
void register_ParticleLayout_class(){
    ...
    { //::ParticleLayout
        ...
        { //::ParticleLayout::getAbundanceFractionOfParticle
            ...
            typedef double ( ::ParticleLayout::*getAbundanceFractionOfParticle_function_type )( ::size_t ) const;
            typedef double ( ParticleLayout_wrapper::*default_getAbundanceFractionOfParticle_function_type )( ::size_t ) const;
