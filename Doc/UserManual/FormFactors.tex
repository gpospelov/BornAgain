...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{Box (cuboid)} \SecLabel{Box}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{Prism3 (triangular)} \SecLabel{Prism3}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{Prism6 (hexagonal)} \SecLabel{Prism6}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{Cone6 (hexagonal)} \SecLabel{Cone6}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{Pyramid (square-based)}\SecLabel{Pyramid}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{AnisoPyramid (rectangle-based)} \SecLabel{AnisoPyramid} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{EllipsoidalCylinder} \SecLabel{EllipsoidalCylinder} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{Cone (circular)} \SecLabel{Cone} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{FullSphere} \SecLabel{FullSphere}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{TruncatedSphere}\SecLabel{Sphere}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{FullSpheroid} \SecLabel{FullSpheroid}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{TruncatedSpheroid} \SecLabel{Spheroid}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{HemiEllipsoid} \SecLabel{HemiEllipsoid}  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{Ripple1 (sinusoidal)} \SecLabel{Ripple1}  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{Ripple2 (saw-tooth)} \SecLabel{Ripple2}  
...
%\begin{figure}[ht]
%\begin{center}
%\includegraphics[angle=-90,width=\textwidth]{fig/cuts/drawingDWBA}
%\end{center}
...
%\begin{figure}[ht]
%\hfill
%\subfigure[Born Approximation]{\includegraphics[width=6cm]{fig/cuts/ffspheroidBA}}
%\hfill
%\subfigure[DWB Approximation]{\includegraphics[width=6cm]{fig/cuts/ffspheroidDWBA}}
%\hfill
...
%\begin{figure}[ht]
%\begin{center}
%\includegraphics[angle=-90,width=\textwidth]{fig/cuts/drawingDWBAburied}
%\end{center}
...
%\begin{figure}[ht]
%\centering
%\includegraphics[width=0.6\textwidth]{fig/cuts/figIntBuriedPart}
...
%\begin{figure}[ht]
%\centering
%\includegraphics[width=0.5\textwidth]{fig/cuts/drawingDepthParticle}
...
%\begin{figure}[ht]
%\hfill
%\subfigure[Side view]{\includegraphics[width=5cm]{fig/cuts/CoreShellParallPyrxz}}
%\hfill
%\subfigure[Top view]{\includegraphics[width=5cm]{fig/cuts/CoreShellParallPyrxy}}
%\hfill
...
%\begin{figure}[ht]
%\begin{center}
%\includegraphics[width=0.6\textwidth]{fig/cuts/CoreShellParallPyr}
%\end{center}
