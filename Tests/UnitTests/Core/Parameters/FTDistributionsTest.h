...
TEST_F(FTDistributionsTest, FTDistribution2DCauchyConstructor)
{
    ...
    EXPECT_EQ(2.0, P_2d_cauchy->parameter("CoherenceLengthY")->getValue());
    EXPECT_EQ(0, P_2d_cauchy->parameter("Gamma")->getValue());
    ...
    EXPECT_EQ(3.0, P_2d_cauchy->parameter("Gamma")->getValue());
