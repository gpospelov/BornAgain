...
\begin{figure}[ht]
\hfill
\subfigure[Side view]{\includegraphics[width=5cm]{Figures/Box2dxz.eps}}
\hfill
\subfigure[Top view]{\includegraphics[width=5cm]{Figures/Box2dxy.eps}}
\hfill
...
%\begin{figure}[ht]
%\begin{center}
%\includegraphics[angle=-90,width=\textwidth]{Figures/drawingDWBA}
%\end{center}
...
%\begin{figure}[ht]
%\begin{center}
%\includegraphics[angle=-90,width=\textwidth]{Figures/drawingDWBAburied}
%\end{center}
