...
GraphicsScene::GraphicsScene() : m_rectangle(0), m_ellipse(0), m_polygon(0), isFinished(true),
...
void GraphicsScene::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
    ...
    if(m_drawing == RECTANGLE && m_rectangle) {
        m_rectangle->boundingRect().setWidth(event->scenePos().x() - m_rectangle->boundingRect().topLeft().x());
