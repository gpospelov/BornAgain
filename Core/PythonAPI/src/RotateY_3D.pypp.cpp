...
struct RotateY_3D_wrapper : Geometry::RotateY_3D, bp::wrapper< Geometry::RotateY_3D > {
    ...
    virtual ::Geometry::BasicVector3D< double > transformed( ::Geometry::BasicVector3D< double > const & v ) const  {
        if( bp::override func_transformed = this->get_override( "transformed" ) )
            ...
            return this->Geometry::RotateY_3D::transformed( boost::ref(v) );
        }
    }
    
    ::Geometry::BasicVector3D< double > default_transformed( ::Geometry::BasicVector3D< double > const & v ) const  {
        return Geometry::RotateY_3D::transformed( boost::ref(v) );
    }
...
void register_RotateY_3D_class(){
    ...
    bp::class_< RotateY_3D_wrapper, bp::bases< Geometry::ITransform3D > >( "RotateY_3D", bp::init< double >(( bp::arg("a") )) )    
        .def( 
            "print"
            , (void ( ::Geometry::RotateY_3D::* )( ::std::ostream & ) const)(&::Geometry::RotateY_3D::print)
            , (void ( RotateY_3D_wrapper::* )( ::std::ostream & ) const)(&RotateY_3D_wrapper::default_print)
            , ( bp::arg("ostr") ) )    
        .def( 
            "transformed"
            , (::Geometry::BasicVector3D< double > ( ::Geometry::RotateY_3D::* )( ::Geometry::BasicVector3D< double > const & ) const)(&::Geometry::RotateY_3D::transformed)
            , (::Geometry::BasicVector3D< double > ( RotateY_3D_wrapper::* )( ::Geometry::BasicVector3D< double > const & ) const)(&RotateY_3D_wrapper::default_transformed)
            , ( bp::arg("v") ) )    
        .def( 
            "transformed"
            , (::Geometry::BasicVector3D< std::complex< double > > ( ::Geometry::RotateY_3D::* )( ::Geometry::BasicVector3D< std::complex< double > > const & ) const)(&::Geometry::RotateY_3D::transformed)
            , (::Geometry::BasicVector3D< std::complex< double > > ( RotateY_3D_wrapper::* )( ::Geometry::BasicVector3D< std::complex< double > > const & ) const)(&RotateY_3D_wrapper::default_transformed)
            , ( bp::arg("v") ) )    
        .def( 
            "inverse"
            , (::Geometry::PTransform3D ( ::Geometry::ITransform3D::* )(  ) const)(&::Geometry::ITransform3D::inverse)
            , (::Geometry::PTransform3D ( RotateY_3D_wrapper::* )(  ) const)(&RotateY_3D_wrapper::default_inverse) );
