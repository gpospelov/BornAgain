...
a neutron beam obtained from a moderator
is completely incoherent in the sense
...
over the differential cross sections (and not the wavefunctions)
of individual neutrons.
In the conventional approach followed here,
each incoming neutron wavefunction is a plane wave,
characterized by a wavenumber $K$ and a direction~$\v{\hat k}_\ti$.
The detector location determines the outgoing direction~$\v{\hat k}_\tf$.
The finite experimental \textit{resolution}
\index{Resolution}%
