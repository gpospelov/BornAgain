...
\chapter{Scattering by embedded particles}  \SecLabel{FormFactors}
...
In \SecRef{CoreShell} we briefly discuss ``core-shell'' particles
...
\hline
Ripple1, \SecRef{Ripple1} &  & Ripple2, \SecRef{Ripple2}&  & Truncated cube \SecRef{Truncatedcube} & &  \\
...
\subsection{Box (cuboid)} \SecLabel{Box}
...
%-------------------------------------------------------------------------------
\newpage
\subsection{Prism3 (triangular)} \SecLabel{Prism3}
...
%-------------------------------------------------------------------------------
\newpage
\subsection{Tetrahedron} \SecLabel{Tetrahedron}
...
%-------------------------------------------------------------------------------
\newpage
\subsection{Prism6 (hexagonal)} \SecLabel{Prism6}
...
%-------------------------------------------------------------------------------
\newpage
\subsection{Cone6 (hexagonal)} \SecLabel{Cone6}
...
%-------------------------------------------------------------------------------
\newpage
\subsection{Pyramid (square-based)}\SecLabel{Pyramid}
...
%-------------------------------------------------------------------------------
\newpage
\subsection{AnisoPyramid (rectangle-based)} \SecLabel{AnisoPyramid} 
...
%-------------------------------------------------------------------------------
\newpage
\subsection{Cuboctahedron} \SecLabel{Cuboctahedron}
...
%-------------------------------------------------------------------------------
\newpage
\subsection{Cylinder} \SecLabel{Cylinder}
...
%-------------------------------------------------------------------------------
\newpage
\subsection{EllipsoidalCylinder} \SecLabel{EllipsoidalCylinder} 
...
%-------------------------------------------------------------------------------
\newpage
\subsection{Cone (circular)} \SecLabel{Cone} 
...
%-------------------------------------------------------------------------------
\newpage
\subsection{FullSphere} \SecLabel{FullSphere}
...
%-------------------------------------------------------------------------------
\newpage
\subsection{TruncatedSphere}\SecLabel{Sphere}
...
%-------------------------------------------------------------------------------
\newpage
\subsection{FullSpheroid} \SecLabel{FullSpheroid}
...
%-------------------------------------------------------------------------------
\newpage
\subsection{TruncatedSpheroid} \SecLabel{Spheroid}
...
%-------------------------------------------------------------------------------
\newpage
\subsection{HemiEllipsoid} \SecLabel{HemiEllipsoid}  
...
%-------------------------------------------------------------------------------
\newpage
\subsection{Ripple1 (sinusoidal)} \SecLabel{Ripple1}  
...
%-------------------------------------------------------------------------------
\newpage
\subsection{Ripple2 (saw-tooth)} \SecLabel{Ripple2}  
...
%-------------------------------------------------------------------------------
\newpage
\subsection{Truncated cube} \SecLabel{Truncatedcube}  
...
\begin{figure}[ht]
\hfill
\subfigure[Side view]{\includegraphics[width=5cm]{fig/cuts/Truncatedcube2dxz.eps}}
\hfill
\subfigure[Top view]{\includegraphics[width=5cm]{fig/cuts/Truncatedcube2dxy.eps}}
\hfill
...
\paragraph{Form factor}
The form factor of the truncated cube is equal to the form factor of the full cube of side length $L$ (see \SecRef{Box}) minus the form factors of the eight trirectangular tetrahedrons.
\begin{align*}
...
% insert figure and reference to article from 
