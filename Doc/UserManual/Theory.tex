...
factors have been implemented in \BornAgain\ and a detailed description is given in Appendix \ref{app:ff}.
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.6\textwidth]{fig/gisasmap/figIntBuriedPart.pdf}
