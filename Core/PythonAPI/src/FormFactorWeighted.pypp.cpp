...
void register_FormFactorWeighted_class(){
    ...
    { //::FormFactorWeighted
        ...
        { //::ISample::getChildren
            ...
            typedef ::std::vector< const ISample* > ( FormFactorWeighted_wrapper::*default_getChildren_function_type)(  ) const;
        ...
        { //::ISample::size
            ...
            typedef ::std::size_t ( FormFactorWeighted_wrapper::*default_size_function_type)(  ) const;
            
            FormFactorWeighted_exposer.def( 
                "size"
                , size_function_type(&::ISample::size)
                , default_size_function_type(&FormFactorWeighted_wrapper::default_size) );
