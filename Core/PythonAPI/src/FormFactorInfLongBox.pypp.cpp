...
void register_FormFactorInfLongBox_class(){
    ...
    { //::FormFactorInfLongBox
        ...
        { //::ISample::preprocess
            ...
            typedef bool ( FormFactorInfLongBox_wrapper::*default_preprocess_function_type)(  ) ;
            
            FormFactorInfLongBox_exposer.def( 
                "preprocess"
                , preprocess_function_type(&::ISample::preprocess)
                , default_preprocess_function_type(&FormFactorInfLongBox_wrapper::default_preprocess) );
