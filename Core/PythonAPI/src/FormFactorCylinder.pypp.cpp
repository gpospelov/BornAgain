...
void register_FormFactorCylinder_class(){
    ...
    { //::FormFactorCylinder
        ...
        { //::ISample::preprocess
            ...
            typedef bool ( FormFactorCylinder_wrapper::*default_preprocess_function_type)(  ) ;
            
            FormFactorCylinder_exposer.def( 
                "preprocess"
                , preprocess_function_type(&::ISample::preprocess)
                , default_preprocess_function_type(&FormFactorCylinder_wrapper::default_preprocess) );
