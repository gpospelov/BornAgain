        ...
        const Bin1DCVector& k_f_bin) const
{
    ...
    ff_BA = mp_form_factor->evaluatePol(ki_1T, kf_1T);
    ...
    ff_BA = mp_form_factor->evaluatePol(ki_1R, kf_1T);
    ...
    ff_BA = mp_form_factor->evaluatePol(ki_1T, kf_1R);
    ...
    ff_BA = mp_form_factor->evaluatePol(ki_1R, kf_1R);
    ...
    ff_BA = mp_form_factor->evaluatePol(ki_1T, kf_2T);
    ...
    ff_BA = mp_form_factor->evaluatePol(ki_1R, kf_2T);
    ...
    ff_BA = mp_form_factor->evaluatePol(ki_1T, kf_2R);
    ...
    ff_BA = mp_form_factor->evaluatePol(ki_1R, kf_2R);
    ...
    ff_BA = mp_form_factor->evaluatePol(ki_2T, kf_1T);
    ...
    ff_BA = mp_form_factor->evaluatePol(ki_2R, kf_1T);
    ...
    ff_BA = mp_form_factor->evaluatePol(ki_2T, kf_1R);
    ...
    ff_BA = mp_form_factor->evaluatePol(ki_2R, kf_1R);
    ...
    ff_BA = mp_form_factor->evaluatePol(ki_2T, kf_2T);
    ...
    ff_BA = mp_form_factor->evaluatePol(ki_2R, kf_2T);
    ...
    ff_BA = mp_form_factor->evaluatePol(ki_2T, kf_2R);
    ...
    ff_BA = mp_form_factor->evaluatePol(ki_2R, kf_2R);
