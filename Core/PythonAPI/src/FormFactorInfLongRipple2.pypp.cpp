...
void register_FormFactorInfLongRipple2_class(){
    ...
    { //::FormFactorInfLongRipple2
        typedef bp::class_< FormFactorInfLongRipple2_wrapper, bp::bases< IFormFactorBorn >, boost::noncopyable > FormFactorInfLongRipple2_exposer_t;
        ...
        { //::IFormFactor::createDistributedFormFactors
            ...
            typedef void ( FormFactorInfLongRipple2_wrapper::*default_createDistributedFormFactors_function_type )( ::std::vector< IFormFactor* > &,::std::vector< double > &,::size_t ) const;
            
            FormFactorInfLongRipple2_exposer.def( 
                "createDistributedFormFactors"
                , createDistributedFormFactors_function_type(&::IFormFactor::createDistributedFormFactors)
                , default_createDistributedFormFactors_function_type(&FormFactorInfLongRipple2_wrapper::default_createDistributedFormFactors)
        ...
        { //::IFormFactor::isDistributedFormFactor
            ...
            FormFactorInfLongRipple2_exposer.def( 
                ...
                , default_isDistributedFormFactor_function_type(&FormFactorInfLongRipple2_wrapper::default_isDistributedFormFactor) );
