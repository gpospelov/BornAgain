...
ISample *IsGISAXS07Builder::buildSample() const
{
    ...
    ParticleInfo particle_info1(Particle(particle_material, ff1),
            pos1, 0.5);
    ...
    ParticleInfo particle_info2(
            Particle(particle_material, ff2, m2), pos2, 0.5);
    ...
    ParticleInfo particle_info3(
            Particle(particle_material, ff3, m3), pos3, 0.5);
    ...
    ParticleInfo particle_info4(
            Particle(particle_material, ff4, m4), pos4, 0.5);
    ...
    ParticleInfo particle_info5(
            Particle(particle_material, ff5, m5), pos5, 0.5);
    ...
    ParticleInfo particle_info6(
            Particle(particle_material, ff6, m6), pos6, 0.5);
    ...
    ParticleInfo particle_info7(
            Particle(particle_material, ff7, m7), pos7, 0.5);
    ...
    ParticleInfo particle_info8(
            Particle(particle_material, ff8, m8), pos8, 0.5);
    ...
    ParticleInfo particle_info9(
            Particle(particle_material, ff9, m9), pos9, 0.5);
    ...
    ParticleInfo particle_info10(
            Particle(particle_material, ff10, m10), pos10, 0.5);
