...
\end{itemize}}
Altogether, PD1--3 make up the \E{decoupling approximation} of \IsGISAXS\
\cite[ch.~2.2.1]{Laz08}.\footnote
{In the \IsGISAXS\ manual,
...
It describes incoherent scattering from different spatial domains.
In \BornAgain,
