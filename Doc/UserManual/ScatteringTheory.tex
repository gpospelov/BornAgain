...
\end{equation}
\nomenclature[1ψ032 00 2r040]{$\psi_0(\r)$}{Solution of the unperturbed stationary Schrödinger equation}
...
\nomenclature[1ψ034 2i000 2r040]{$\psi_\text{i}(\r)$}{Incident wave function}%
...
\end{equation}
\nomenclature[1ψ034 2f000 2r040]{$\psi_\text{f}(\r)$}{Plane wave propagating from the sample towards the detector}%
