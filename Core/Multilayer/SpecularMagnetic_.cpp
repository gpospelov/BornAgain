...
std::vector<MatrixRTCoefficients_v2> SpecularMagnetic_::execute(const std::vector<Slice>& slices,
                                                              const kvector_t& k)
{
...
void SpecularMagnetic_::calculateTR(MatrixRTCoefficients_v2& coeff)
{
...
void SpecularMagnetic_::calculateZeroFieldTR(MatrixRTCoefficients_v2& coeff)
{
...
void SpecularMagnetic_::setNoTransmission(MatrixRTCoefficients_v2& coeff)
{
...
void SpecularMagnetic_::nullifyBottomReflection(MatrixRTCoefficients_v2& coeff)
{
    const complex_t l_1 = coeff.m_lambda(0);
    const complex_t l_2 = coeff.m_lambda(1);
...
void SpecularMagnetic_::propagateBackwards(std::vector<MatrixRTCoefficients_v2>& coeff,
...
Eigen::Matrix2cd
SpecularMagnetic_::findNormalizationCoefficients(const MatrixRTCoefficients_v2& coeff)
{
...
void SpecularMagnetic_::propagateForwards(std::vector<MatrixRTCoefficients_v2>& coeff,
