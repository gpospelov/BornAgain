...
\begin{align*}
  ...
  S_{\alpha\beta} (\vect{q}) &\equiv 1 + \rho_V \int_V d^3\vect{r}\mathcal{G}_{\alpha\beta}(\vect{r}) \exp \left[ i\vect{q}\cdot \vect{r} \right].
\end{align*}
