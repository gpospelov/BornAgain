...
void register_InterferenceFunctionNone_class(){
    ...
    { //::InterferenceFunctionNone
        ...
        { //::ISample::getChildren
            ...
            typedef ::std::vector< const ISample* > ( InterferenceFunctionNone_wrapper::*default_getChildren_function_type)(  ) const;
            
            InterferenceFunctionNone_exposer.def( 
                "getChildren"
                , getChildren_function_type(&::ISample::getChildren)
                , default_getChildren_function_type(&InterferenceFunctionNone_wrapper::default_getChildren) );
        ...
        { //::IInterferenceFunction::getParticleDensity
            ...
            typedef double ( InterferenceFunctionNone_wrapper::*default_getParticleDensity_function_type)(  ) const;
            
            InterferenceFunctionNone_exposer.def( 
                "getParticleDensity"
                , getParticleDensity_function_type(&::IInterferenceFunction::getParticleDensity)
                , default_getParticleDensity_function_type(&InterferenceFunctionNone_wrapper::default_getParticleDensity) );
        ...
        { //::ISample::size
            ...
            typedef ::std::size_t ( InterferenceFunctionNone_wrapper::*default_size_function_type)(  ) const;
            
            InterferenceFunctionNone_exposer.def( 
                "size"
                , size_function_type(&::ISample::size)
                , default_size_function_type(&InterferenceFunctionNone_wrapper::default_size) );
