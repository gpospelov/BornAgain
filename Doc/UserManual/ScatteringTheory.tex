...
Since both the incindent
\begin{equation}
  \Psi_\text{i}(\r)
  = \Psi^-_\text{i}(z) + \Psi^+_\text{i}(z),
\end{equation}
...
the matrix element (\ref{Etrama}) consists of four components,
...
Therefore, the four terms of (\ref{EtmDWBA}) can interfer with each other,
...
the investigated sample consists of a number of distinct layers~$j$.
