...
void register_FormFactorCylinder_class(){
    ...
    { //::FormFactorCylinder
        ...
        { //::IFormFactorBorn::evaluate
            ...
            typedef ::complex_t ( FormFactorCylinder_wrapper::*default_evaluate_function_type)( ::WavevectorInfo const & ) const;
        ...
        { //::ISample::getChildren
            ...
            typedef ::std::vector< const ISample* > ( FormFactorCylinder_wrapper::*default_getChildren_function_type)(  ) const;
            
            FormFactorCylinder_exposer.def( 
                "getChildren"
                , getChildren_function_type(&::ISample::getChildren)
                , default_getChildren_function_type(&FormFactorCylinder_wrapper::default_getChildren) );
        ...
        { //::IFormFactor::setAmbientMaterial
            ...
            typedef void ( FormFactorCylinder_wrapper::*default_setAmbientMaterial_function_type)( ::IMaterial const & ) ;
            
            FormFactorCylinder_exposer.def( 
                "setAmbientMaterial"
                , setAmbientMaterial_function_type(&::IFormFactor::setAmbientMaterial)
                , default_setAmbientMaterial_function_type(&FormFactorCylinder_wrapper::default_setAmbientMaterial)
                , ( bp::arg("arg0") ) );
        ...
        { //::ISample::size
            ...
            typedef ::std::size_t ( FormFactorCylinder_wrapper::*default_size_function_type)(  ) const;
            
            FormFactorCylinder_exposer.def( 
                "size"
                , size_function_type(&::ISample::size)
                , default_size_function_type(&FormFactorCylinder_wrapper::default_size) );
        
        }
        { //::ICloneable::transferToCPP
        
            typedef void ( ::ICloneable::*transferToCPP_function_type)(  ) ;
            typedef void ( FormFactorCylinder_wrapper::*default_transferToCPP_function_type)(  ) ;
            
            FormFactorCylinder_exposer.def( 
                "transferToCPP"
                , transferToCPP_function_type(&::ICloneable::transferToCPP)
                , default_transferToCPP_function_type(&FormFactorCylinder_wrapper::default_transferToCPP) );
