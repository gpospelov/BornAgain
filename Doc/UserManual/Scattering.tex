...
we posit homogeneous differential equations for plane waves and distorted waves,
and corresponding equations for singular inhomogeneities,
\begin{equation}
  \begin{array}{l@{\hspace{2em}}l}
...
\Work{Conclusion to be revised \ldots} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
