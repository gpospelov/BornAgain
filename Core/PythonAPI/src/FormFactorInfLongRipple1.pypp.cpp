...
struct FormFactorInfLongRipple1_wrapper : FormFactorInfLongRipple1, bp::wrapper< FormFactorInfLongRipple1 > {
    ...
    virtual ::complex_t evaluate( ::WavevectorInfo const & wavevectors ) const  {
        if( bp::override func_evaluate = this->get_override( "evaluate" ) )
            ...
            return this->FormFactorInfLongRipple1::evaluate( boost::ref(wavevectors) );
        }
    }
    
    ::complex_t default_evaluate( ::WavevectorInfo const & wavevectors ) const  {
        return FormFactorInfLongRipple1::evaluate( boost::ref(wavevectors) );
    }
...
void register_FormFactorInfLongRipple1_class(){
    ...
    { //::FormFactorInfLongRipple1
        ...
        { //::FormFactorInfLongRipple1::evaluate
            ...
            typedef ::complex_t ( ::FormFactorInfLongRipple1::*evaluate_function_type)( ::WavevectorInfo const & ) const;
            typedef ::complex_t ( FormFactorInfLongRipple1_wrapper::*default_evaluate_function_type)( ::WavevectorInfo const & ) const;
