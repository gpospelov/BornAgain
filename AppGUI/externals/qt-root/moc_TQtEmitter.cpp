...
struct qt_meta_stringdata_TQtEmitter_t {
    QByteArrayData data[5];
    char stringdata[35];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_TQtEmitter_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_TQtEmitter_t qt_meta_stringdata_TQtEmitter = {
    {
...
QT_MOC_LITERAL(4, 32, 1)
    ...
    "TQtEmitter\0padPainted\0\0QPixmap*\0p\0"
};
...
void TQtEmitter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TQtEmitter::*_t)(QPixmap * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TQtEmitter::padPainted)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject TQtEmitter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TQtEmitter.data,
      qt_meta_data_TQtEmitter,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TQtEmitter.stringdata))
