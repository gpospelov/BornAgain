...
BA_CORE_API_ Particle3DContainer singleParticle3DContainer(
        const Particle& particle, double total_abundance = 1.0,
...
BA_CORE_API_ std::vector<Particle3DContainer> particleDistribution3DContainer(
