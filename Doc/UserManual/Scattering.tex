...
Maxwell's equations can then combined to yield a wave equation,
...
\begin{equation}
  \v{\epsilon} = \overline{\epsilon}(\r) + \delta\v{\epsilon}(\r).
\end{equation}
...
\cref{EwaveE3} becomes identical with the perturbed Schrödinger equation~\cref{ESchrodiK}.
