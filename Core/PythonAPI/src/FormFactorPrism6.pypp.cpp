...
void register_FormFactorPrism6_class(){
    ...
    { //::FormFactorPrism6
        ...
        { //::FormFactorPrism6::setHeight
            ...
            typedef void ( FormFactorPrism6_wrapper::*default_setHeight_function_type)( double ) ;
        ...
        { //::IFormFactorBorn::evaluate
            ...
            typedef ::complex_t ( FormFactorPrism6_wrapper::*default_evaluate_function_type)( ::cvector_t const &,::Bin1DCVector const & ) const;
