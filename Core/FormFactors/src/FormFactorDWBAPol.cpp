        ...
        const Bin1DCVector& k_f_bin, const Bin1D &alpha_f_bin, const Bin1D &phi_f_bin) const
{
    ...
    boost::scoped_ptr<const ILayerRTCoefficients> P_out_lower(
                getOutCoeffs(alpha_f_bin.m_lower,
                             phi_f_bin.m_lower));
    boost::scoped_ptr<const ILayerRTCoefficients> P_out_upper(
                getOutCoeffs(alpha_f_bin.m_upper,
                             phi_f_bin.m_upper));
