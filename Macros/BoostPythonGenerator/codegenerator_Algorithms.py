...
# ---------------------------------------------------------
# to let pyplusplus know that given classes are already exposed by other converter
# ---------------------------------------------------------
mb.class_('KVector<double>').already_exposed=True
mb.class_('MultiLayer').already_exposed=True
#mb.class_('PyHelperOpticalFresnel').exclude()
...
mb.write_module( 'WrapperCode_Algorithms.cpp' )
