...
TEST_P(FFSymmetryTest, Prism6)
{
    ...
    test_qq_eq( &p, q, q.rotatedZ(-Units::PI2/3), 3.5e-12 );
}
...
TEST_P(FFSymmetryTest, Tetrahedron)
{
    ...
    test_qq_eq( &p, q, q.rotatedZ(Units::PI2/3), 8e-12 );
}
...
TEST_P(FFSymmetryTest, Cone6_flat)
{
    ...
    test_qq_eq( &p, q, q.rotatedZ(-Units::PI/3), 8e-12 );
}
...
TEST_P(FFSymmetryTest, Cone6_steep)
{
    ...
    test_qq_eq( &p, q, q.rotatedZ(-Units::PI/3), 1.6e-11 );
}
