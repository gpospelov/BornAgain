...
//
//! @file      Fit/Minimizer/ObsoleteMinimizerOptions.h
//! @brief     Defines class ObsoleteMinimizerOptions.
//!
...
#ifndef OBSOLETEMINIMIZEROPTIONS_H
#define OBSOLETEMINIMIZEROPTIONS_H
...
class BA_CORE_API_ ObsoleteMinimizerOptions
{
public:
