...
with the parameters
\begin{itemize}
\item \texttt{length} $=L$ is the full length of the base,
\item \texttt{width} $=W$ is the full width of the base,
\item \texttt{height} $=H$ is the height,
\item \texttt{alpha} $=\alpha$ is the angle between the base and a side face.
\end{itemize}
They must fulfill
\begin{displaymath}
