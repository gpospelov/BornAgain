...
\end{equation}
\nomenclature[2j0]{$j$}{Index of layer in multilayer sample}%
\nomenclature[2a5wj$\pm$]{$A^\pm_{wj}$}{Amplitude of the plane wave $\Psi^\pm_{wj}(\r)$}%
...
\end{equation}
\nomenclature[2z3]{$\v{\hat z}$}{Unit vector along the sample normal}%
\nomenclature[2k5wj$\pm$]{$\k^\pm_{wj}$}{Wave vector of the plane wave $\Psi^\pm_{wj}(\r)$}%
...
\end{equation}
\nomenclature[1$\chi$qj]{$\chi_j(\v{q})$}{Fourier transform of the perturbation potential $\chi(\r)$, evaluated in one sample layer}%
