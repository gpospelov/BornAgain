...
\Note{\indent In all of the following, we make the assumption
  that all particle properties like shape, size, and orientation,
  are independent and identically distributed (\E{i.i.d.}) random variables.}

This is one ingredient of the \E{decoupling approximation} of \IsGISAXS\
