...
% More information about the general software architecture and \BornAgain\ internal design are given in Sec.~\ref{sec:SoftwareArchitecture}.
...
%Sec.~\ref{sec:FittingGentleIntroducion} gives a short introduction to the
%basic concepts of data fitting. Users familiar with fitting can
%directly proceed to Sec.~\ref{sec:FittingImplementation}, which details the
...
%Details of \Code{FitSuite} class implementation and description of each interface are given in Sec.~\ref{sec:FitSuiteClass}.
...
%As it has already been mentioned in Sec.~\ref{sec:FittingGentleIntroducion},
