...
void register_FormFactorTruncatedSphere_class(){
    ...
    { //::FormFactorTruncatedSphere
        ...
        { //::IFormFactor::createDistributedFormFactors
            ...
            typedef void ( FormFactorTruncatedSphere_wrapper::*default_createDistributedFormFactors_function_type )( ::std::vector< IFormFactor* > &,::std::vector< double > &,::size_t ) const;
