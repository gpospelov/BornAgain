...
\index{Particles!dilute assembly}%
...
the usual three-dimensional, microscopic, atomistic crystals of conventional solid-state physics.
\index{Crystal!microscopic (unsupported)}%
It is quite possible mesoparticles are made of microscopic crystals,
and cause wide-angle scattering,
but this is ignored in BornAgain;
BornAgain does not support for any wide-angle scattering simulation.
\index{Wide-angle scattering (unsupported)}%

by a \E{crystal}
\index{Nanocrystal|see{Crystal}}%
We are explicitly \E{not} concerned with
