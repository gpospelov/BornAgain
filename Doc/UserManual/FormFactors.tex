...
\section{Box} \SecLabel{Box}
  ...
  \index{Prism (form factor)!reactangular}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{Prism3} \SecLabel{Prism3}
  \index{Prism (form factor)!triangular}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{Prism6} \SecLabel{Prism6}
  \index{Prism (form factor)!hexagonal}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{Cone6} \SecLabel{Cone6}
  \index{Cone (form factor)!hexagonal}
  \index{Pyramid (form factor)!hexagonal}
  \index{Truncated pyramid (form factor)!hexagonal}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{Anisotropic pyramid} \SecLabel{AnisoPyramid} 
  ...
  \index{Pyramid (form factor)!rectangular base}
  \index{Truncated pyramid (form factor)!rectangular base}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{Ripple1} \SecLabel{Ripple1}  
  \index{Ripple (form factor)!sinusoidal}
...
\section{Ripple2} \SecLabel{Ripple2}  
  \index{Ripple (form factor)!saw-tooth}
