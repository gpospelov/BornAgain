...
void register_FormFactorTruncatedSphere_class(){
    ...
    { //::FormFactorTruncatedSphere
        ...
        { //::IFormFactor::createDistributedFormFactors
            ...
            typedef void ( FormFactorTruncatedSphere_wrapper::*default_createDistributedFormFactors_function_type )( ::std::vector< IFormFactor* > &,::std::vector< double > &,::std::size_t ) const;
            
            FormFactorTruncatedSphere_exposer.def( 
                "createDistributedFormFactors"
                , createDistributedFormFactors_function_type(&::IFormFactor::createDistributedFormFactors)
                , default_createDistributedFormFactors_function_type(&FormFactorTruncatedSphere_wrapper::default_createDistributedFormFactors)
        ...
        { //::IFormFactor::isDistributedFormFactor
            ...
            typedef bool ( FormFactorTruncatedSphere_wrapper::*default_isDistributedFormFactor_function_type )(  ) const;
            
            FormFactorTruncatedSphere_exposer.def( 
                "isDistributedFormFactor"
                , isDistributedFormFactor_function_type(&::IFormFactor::isDistributedFormFactor)
                , default_isDistributedFormFactor_function_type(&FormFactorTruncatedSphere_wrapper::default_isDistributedFormFactor) );
