...
factorize the wave function into an in-plane and a perpendicular function,
...
and describe how the vertical wave function is computed in BornAgain.
...
\begin{equation}\label{EdwbalE}
  ...
  = \sum_l \sum_{\pm_\si} \sum_{\pm_\sf}
    \bra \v{E}^\pm_{\si l}|\delta v|\v{E}^\pm_{\sf l}\ket.
\end{equation}%
\vspace*{-5pt}}
...
%===============================================================================
\section{Polarization factors for X-rays}\label{SXpolfac}
%===============================================================================
...
\index{Polarization!p and s}%
\index{p-Polarization}%
\index{s-Polarization}%
For $p$ polarization, the electric field vector is parallel to the interface normal;
