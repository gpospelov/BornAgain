...
FitView::FitView(SampleModel *sModel, InstrumentModel *iModel, QWidget *parent)
    : QWidget(parent)
    ...
    , m_instrumentModel(iModel)
{
    ...
    m_fitParameterModel = new FitModel(3, FitModel::FitParameterModel);
    ...
    std::cout<<"============================================================================= \n";
    m_sampleParameterModel = new FitModel(2, FitModel::ProxySampleModel);
...
ParameterizedItem* FitView::extractSampleModel(const QModelIndex &parentIndex, ParameterizedItem *parentItem){
...
void FitView::addPropertyToItem(ParameterizedItem *parentItem, const QString &name, const QString &property_name, QVariant &value){
...
ParameterizedItem* FitView::extractInstrumentModel(){
...
ParameterizedItem* FitView::iterateInstrumentItem(InstrumentItem *instrument){
...
void FitView::sampleSelectionChanged(const QItemSelection &newSelection, const QItemSelection &oldSelection){
...
void FitView::fitParameterSelectionChanged(const QItemSelection &newSelection, const QItemSelection &oldSelection){
