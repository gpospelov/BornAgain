...
Implemented particle form factors are described in Appendix~\ref{SFF}.
...
%===============================================================================
\subsection{Shape transform} \label{Sshapetrafo}
%===============================================================================

\index{Shape transform|(}
The form factor (\ref{EFFdef}) of a particle is the Fourier transform
...
plus some ripples.
Each geometry is is documented in standardized form in Appendix~\ref{SFF}.

\index{Shape transform|)}


%===============================================================================
\subsection{Core-shell particles} \label{sec:CoreShell}
%===============================================================================
\index{Core-shell particles}

For particles that are made of different materials,
the definition (\ref{EFFdef}) of the form factor~$F(\q)$
must be generalized in obvious ways,
not worth explicit documentation.
In practice, the most important case is the core-shell particle.
...
and \Code{relative\_\discretionary{}{}{}core\_\discretionary{}{}{}position} specifies the position of the
...
\begin{lstlisting}
    ...
    core_position = kvector_t(1.5*nanometer, 0.0, 0.0)
