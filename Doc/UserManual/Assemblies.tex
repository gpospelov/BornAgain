...
These two cases are not covered by first-order scattering theory anyway;
in experiments, the transmitted and the reflected beam are typically absorbed by a beamstop.
