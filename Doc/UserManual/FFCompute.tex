...
To compute the two-dimensional form factor of a polyhedron,
we use Green's theorem
\begin{equation}
  \int\int\!\d^2\,\v{\partial}\wedge\v{G} = \oint \d\v{r}\cdot\v{G}
\end{equation}
...
We choose
\begin{equation}
 \v{G}\coloneqq\v{a} g \text{ with } g\coloneqq\e^{i\q\r}
\end{equation}
to obtain the form factor as a line integral
\begin{equation}
  F(\q)=\frac{1}{i \q\wedge\v{a}} \oint \d\v{r}\cdot\v{a}\,g.
\end{equation}
