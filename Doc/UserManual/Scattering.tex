...
%===============================================================================
\subsection{Polarized neutrons}\label{Snpwave}
%===============================================================================
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Perturbed wave equation}\label{SPWE}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{equation}
\nomenclature[1d030 2v230 2r040]{$\delta v(\r)$}{Part
 of the scattering length density that causes scattering}%
\nomenclature[2v021]{$\mv$}{Part
 of the scattering length density that can be handled analytically}%
