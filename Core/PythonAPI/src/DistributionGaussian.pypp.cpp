...
void register_DistributionGaussian_class(){
    ...
    { //::DistributionGaussian
        ...
        { //::DistributionGaussian::generateValueList
            ...
            typedef ::std::vector< double > ( ::DistributionGaussian::*generateValueList_function_type)( ::size_t,double,::AttLimits const & ) const;
            typedef ::std::vector< double > ( DistributionGaussian_wrapper::*default_generateValueList_function_type)( ::size_t,double,::AttLimits const & ) const;
        ...
        { //::IDistribution1D::generateValues
            ...
            typedef ::std::vector< double > ( DistributionGaussian_wrapper::*default_generateValues_function_type)( ::size_t,double,double ) const;
