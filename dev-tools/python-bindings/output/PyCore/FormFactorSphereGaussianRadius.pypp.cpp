...
void register_FormFactorSphereGaussianRadius_class(){
    ...
    { //::FormFactorSphereGaussianRadius
        ...
        { //::IFormFactor::setAmbientMaterial
            ...
            typedef void ( FormFactorSphereGaussianRadius_wrapper::*default_setAmbientMaterial_function_type)( ::IMaterial const & ) ;
            
            FormFactorSphereGaussianRadius_exposer.def( 
                "setAmbientMaterial"
                , setAmbientMaterial_function_type(&::IFormFactor::setAmbientMaterial)
                , default_setAmbientMaterial_function_type(&FormFactorSphereGaussianRadius_wrapper::default_setAmbientMaterial)
                , ( bp::arg("material") ) );
        ...
        { //::ICloneable::transferToCPP
            ...
            typedef void ( FormFactorSphereGaussianRadius_wrapper::*default_transferToCPP_function_type)(  ) ;
            
            FormFactorSphereGaussianRadius_exposer.def( 
                "transferToCPP"
                , transferToCPP_function_type(&::ICloneable::transferToCPP)
                , default_transferToCPP_function_type(&FormFactorSphereGaussianRadius_wrapper::default_transferToCPP) );
