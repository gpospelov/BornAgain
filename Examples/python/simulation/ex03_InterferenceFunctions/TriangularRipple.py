...
def get_sample():
    ...
    ripple2_ff = ba.FormFactorRipple2(100*nanometer, 20*nanometer, 4*nanometer, -3.0*nanometer)
    ...
    pdf = ba.FTDecayFunction2DGauss(1000.*nanometer/2./numpy.pi, 100.*nanometer/2./numpy.pi)
