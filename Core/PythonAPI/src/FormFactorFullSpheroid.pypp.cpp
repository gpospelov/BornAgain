...
void register_FormFactorFullSpheroid_class(){
    ...
    { //::FormFactorFullSpheroid
        ...
        { //::ISample::preprocess
            ...
            typedef bool ( FormFactorFullSpheroid_wrapper::*default_preprocess_function_type)(  ) ;
            
            FormFactorFullSpheroid_exposer.def( 
                "preprocess"
                , preprocess_function_type(&::ISample::preprocess)
                , default_preprocess_function_type(&FormFactorFullSpheroid_wrapper::default_preprocess) );
