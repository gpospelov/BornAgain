...
%===============================================================================
\subsection{Distorted-wave Born approximation}\label{SDWBA}
%===============================================================================
...
by a source-detector \textit{reciprocity} theorem
\index{Reciprocity}%
that is proven in Appendix~\label{Sreci1}.
It states that that the far-field Green function
is still given by (\ref{EGreenFar}),
\begin{equation}\label{EGreenFar2}
  G_\text{far}(\r,\r')
  = \frac{\e^{iKr}}{4\pi r}\psi^*_\tf(\r'),
\end{equation}
