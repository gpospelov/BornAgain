...
Parallelepiped, \SecRef{Parallelepiped}  &  & Box,\SecRef{Box} & & Prism3, \SecRef{Prism3} \\
 \includegraphics[width=1in]{Figures/Parallelepiped3d.eps} &
 &  \includegraphics[width=1in]{Figures/Box3d.eps} &
 & \includegraphics[width=1in]{Figures/Prism33d.eps} \\
\hline 
Tetrahedron, \SecRef{Tetrahedron}   & & Prism6, \SecRef{Prism6}    & & Cone6, \SecRef{Cone6}  \\
\includegraphics[width=1in]{Figures/Tetrahedron3d.eps} & & 
\includegraphics[width=1in]{Figures/Prism63d.eps} & & 
 \includegraphics[width=1in]{Figures/Cone63d.eps}  \\
\hline
  Pyramid, \SecRef{Pyramid}  &  & Anisotropic pyramid, \SecRef{AnisoPyramid} & &  Cuboctahedron, \SecRef{Cuboctahedron}   \\
\parbox[c]{1em}{\includegraphics[width=1in]{Figures/Pyramid3d.eps}}
   &   & \parbox[c]{1em}{
      \includegraphics[width=1in]{Figures/AnistropicPyramid3d.eps}} &
    & \parbox[c]{1em}{\includegraphics[width=1in]{Figures/Cuboctahedron3d.eps}}\\
\hline
\end{tabulary}
\end{table}
...
\hline
 Cylinder, \SecRef{Cylinder}  & & Ellipsoidal cylinder, \SecRef{EllipsoidalCylinder}  & &  Cone, \SecRef{Cone} \\
     \parbox[c]{1em}{\includegraphics[width=1in]{Figures/Cylinder3d.eps}} &
& \parbox[c]{1em}{\includegraphics[width=1in]{Figures/EllipsoidalCylinder3d.eps}}
& & \parbox[c]{1em}{\includegraphics[width=1in]{Figures/Cone3d.eps}} \\
\hline
Full Sphere, \SecRef{FullSphere}   &  & Truncated Sphere, \SecRef{Sphere}  & & Full Spheroid, \SecRef{FullSpheroid} \\
 \parbox[c]{1em}{\includegraphics[width=1in]{Figures/FullSphere3d.eps}} & &  \parbox[c]{1em}{\includegraphics[width=1in]{Figures/Sphere3d.eps}}
 &  & \parbox[c]{1em}{\includegraphics[width=1in]{Figures/FullSpheroid3d.eps}}\\
\hline 
 Truncated Spheroid, \SecRef{Spheroid}   &  & Hemi Ellipsoid, \SecRef{HemiEllipsoid}   & & \\
\parbox[c]{1em}{\includegraphics[width=1in]{Figures/Spheroid3d.eps}}
& &\parbox[c]{1em}{\includegraphics[width=1in]{Figures/HemiEllipsoid3d.eps}}
& & \\
\hline
  Ripple1, \SecRef{Ripple1}   &  & Ripple2, \SecRef{Ripple2}   & &\\
\parbox[c]{1em}{\includegraphics[width=1in]{Figures/Ripple13d.eps}} &
& \parbox[c]{1em}{\includegraphics[width=1in]{Figures/Ripple23d.eps}} & & \\
\hline 
\end{tabulary}
\end{table}
...
%\begin{table}[ht] 
%\caption{Table of form factors implemented in \BornAgain.} \label{tab:formfactors}
%  \begin{tabularx}{0.95\textwidth}{Xc Xc X} 
%\hline 
%Shape & &   Shape& &   Shape \\
%\hline 
%Parallelepiped, \SecRef{Parallelepiped}  &  & Box,\SecRef{Box} & & Prism3, \SecRef{Prism3} \\
...
This shape is a square cuboid (see fig.~\ref{parallelepiped}).
...
\subsection{Real-space geometry}
It is a combination of two pyramids with square bases, as shown in fig.~\ref{cuboctahedron}: the bottom one
...
\item $\alpha$ is the angle between the base and the
  ...
  fig.~\ref{pyramid} in \SecLabel{Pyramid}).
\end{itemize}
...
\subsection{Real-space geometry}
This shape has a sinusoidal profile (see fig.~\ref{ripple1}).
...
\subsection{Examples}
Figure~\ref{figFFripple1Ex} shows the normalized intensity
...
\subsection{Real-space geometry}
This shape has an asymmetric sawtooh profile.
...
\subsection{Examples}
Figure~\ref{figFFripple2Ex} shows the normalized intensity
