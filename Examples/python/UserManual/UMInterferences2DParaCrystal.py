...
def get_sample():
    """
    Build and return the sample representing 2D paracrystal with truncated spheres
    forming an hexagonal pattern
    """
    ...
    # interferences
    interference = InterferenceFunction2DParaCrystal.createHexagonal(30.0*nanometer,
                                                                     0.0, 40.0*micrometer, 40.0*micrometer)
