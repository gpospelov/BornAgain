...
\begin{equation}\label{EsumRF}
  \bra\psi_\si|\delta v|\psi_\sf\ket
  = \sum_j \e^{i\q_\plll \R_{j\plll}}  \FD(\q_\plll,\v{T}_j).
\end{equation}
...
\end{equation}
$F(\q_\plll,z,\v{T})$ is an \E{intermediate Fourier transform},
...
\begin{equation}\label{EFqTdef}
  F_l(\q,\v{T})
  \coloneqq \int\!\d z\, \e^{iq^u_l z} F(q_\plll,z,\v{T}) \chi_l(z)
